...
<!-- page title -->
<?= $this->section('title') ?>Donation File Editor<?= $this->endSection() ?>
...
$breadcrumb_links = array(
    ...
    array('title' => 'Edit View Donation File')
);
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        Editing <?='.../Views/front-end/themes/'.getCurrentTheme().'/donate/'.$viewDonationFilename?>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 60em; width: 100%;"><?= htmlspecialchars($viewDonationFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $viewDonationFilePath ?>">
