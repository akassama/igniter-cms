...
<!-- page title -->
<?= $this->section('title') ?>Donations File Editor<?= $this->endSection() ?>
...
$breadcrumb_links = array(
    ...
    array('title' => 'Edit Donations File')
);
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        Editing <?='.../Views/front-end/themes/'.getCurrentTheme().'/donate/'.$donationsFilename?>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 60em; width: 100%;"><?= htmlspecialchars($donationsFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $donationsFilePath ?>">
                    <input type="hidden" name="filePage" value="donations">
