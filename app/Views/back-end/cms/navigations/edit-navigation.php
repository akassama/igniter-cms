    ...
    <div class="col-12 bg-light rounded p-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <textarea rows="1" class="form-control" id="description" name="description" required><?= $navigation_data['description'] ?></textarea>
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input type="text" class="form-control alphanumeric" id="group" name="group" data-show-err="true" maxlength="100" value="<?= $navigation_data['group'] ?>">
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-12 mb-3">
                ...
                <select class="form-select" id="parent" name="parent">
                    ...
                    <?= getNavigationParents($navigation_data['parent']) ?>
                </select>
                <!-- Error -->
