...
<!-- page title -->
<?= $this->section('title') ?>View Portfolio File Editor<?= $this->endSection() ?>
...
$breadcrumb_links = array(
    ...
    array('title' => 'Edit View Portfolio File')
);
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        Editing <?='.../Views/front-end/themes/'.getCurrentTheme().'/portfolios/'.$viewPortfolioFilename?>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 60em; width: 100%;"><?= htmlspecialchars($viewPortfolioFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $viewPortfolioFilePath ?>">
                    <input type="hidden" name="filePage" value="view-portfolio">
