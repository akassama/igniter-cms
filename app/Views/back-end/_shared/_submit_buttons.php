...
<?php else: ?>
    <button type="submit" class="btn btn-outline-primary float-end live-submit-btn" id="submit-btn">
        <i class="ri-send-plane-fill"></i>
        <?= esc($submitLabel) ?>
    </button>
<?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('submit', function(e) {
        const form = e.target;
        const submitBtn = form.querySelector('.live-submit-btn');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.classList.contains('live-submit-btn')) {
            const btn = e.target;
