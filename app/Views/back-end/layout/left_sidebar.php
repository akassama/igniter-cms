                        ...
                        <?php if (isFeatureEnabled('FEATURE_PLUGINS')): ?>
                            ...
                            <div class="collapse" id="collapsePlugins" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link <?= (str_contains(current_url(), 'account/plugins/data')) ? 'active' : ''; ?>" href="<?= base_url('/account/plugins/data'); ?>">
                                        <i class="ri-arrow-drop-right-fill"></i> Plugins Data
                                    </a>
                                </nav>
                            </div>
                        <?php endif; ?>
