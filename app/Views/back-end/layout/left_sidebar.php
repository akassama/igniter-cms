        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <?php if (isFeatureEnabled('FEATURE_CMS')): ?>
                        ...
                        <div class="collapse" id="collapseCMS" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link <?= (str_contains(current_url(), 'account/cms/galleries')) ? 'active' : ''; ?>" href="<?= base_url('/account/cms/galleries'); ?>">
                                    <i class="ri-arrow-drop-right-fill"></i> Gallery
                                </a>
                                ...
                                <a class="nav-link <?= (str_contains(current_url(), 'account/cms/appointments')) ? 'active' : ''; ?>" href="<?= base_url('/account/cms/appointments'); ?>">
                                    <i class="ri-arrow-drop-right-fill"></i> Appointments
                                </a>
                    ...
                    <?php if (isFeatureEnabled('FEATURE_ECOMMERCE')): ?>
                        <!--ECommerce Feature Nav Links-->
                    ...
                    <?php if (isFeatureEnabled('FEATURE_RESUMES')): ?>
                        <!--Resumes Feature Nav Links-->
                        ...
                        <?php if (isFeatureEnabled('FEATURE_ADMIN')): ?>
                            ...
                            <div class="collapse" id="collapseAdmin" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link <?= (str_contains(current_url(), 'account/admin/bookings')) ? 'active' : ''; ?>" href="<?= base_url('/account/admin/bookings'); ?>">
