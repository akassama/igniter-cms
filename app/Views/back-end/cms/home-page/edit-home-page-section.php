    ...
    <div class="col-12 bg-light rounded p-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 mb-3">
                ...
                <input type="text" class="form-control integer-plus-only" id="order" name="order" data-show-err="true" maxlength="2" value="<?= $home_page_data['order'] ?>" required>
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-12 mb-3">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="section_image" name="section_image" value="<?= $home_page_data['section_image'] ?>" placeholder="select image" required>
            ...
            <div class="col-sm-12 col-md-12 mb-3">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="section_image_2" name="section_image_2" value="<?= $home_page_data['section_image_2'] ?>" placeholder="select image" required>
                    <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#imageFilesModal">
                        <i class="ri-image-fill"></i>
                    </button>
                </div>
            ...
            <div class="col-sm-12 col-md-12 mb-3">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="section_image_3" name="section_image_3" value="<?= $home_page_data['section_image_3'] ?>" placeholder="select image" required>
                    <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#imageFilesModal">
                        <i class="ri-image-fill"></i>
                    </button>
                </div>
            ...
            <div class="col-sm-12 col-md-12 mb-3">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="section_image_4" name="section_image_4" value="<?= $home_page_data['section_image_4'] ?>" placeholder="select image" required>
                    <button class="btn btn-dark" type="button" data-bs-toggle="modal" data-bs-target="#imageFilesModal">
                        <i class="ri-image-fill"></i>
                    </button>
                </div>
