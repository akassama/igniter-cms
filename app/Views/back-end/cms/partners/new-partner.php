...
<!-- page title -->
<?= $this->section('title') ?>New Partner<?= $this->endSection() ?>
...
<div class="row">
    ...
    <div class="col-12 bg-light rounded p-4">
        ...
        <?php echo form_open(base_url('account/cms/partners/new-partner'), 'method="post" class="row g-3 needs-validation save-changes" enctype="multipart/form-data" novalidate'); ?>
        <div class="row">
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="logo" name="logo" placeholder="select logo" value="<?= set_value('logo') ?>"
