    ...
    <div class="col-12 bg-light rounded p-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="icon" name="icon" data-show-err="true" maxlength="250" value="<?= htmlspecialchars(set_value('icon')) ?>">
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="group" name="group" data-show-err="true" maxlength="250" value="<?= set_value('group') ?>">
                <!-- Error -->
