 ...
 * 
 * Represents the model for the product_categories table in the database.
 */
class ProductCategoriesModel extends Model
{
    ...
    public function createProductCategory($param = array())
    {
        $categoryId = getGUID();
        $data = [
    ...
    public function updateProductCategory($categoryId, $param = [])
    {
