...
<div class="container py-5">
    <h1 class="mb-4">Articles by Source: <?= esc(ucfirst($type ?? '')) ?> “<?= esc($sourceName) ?>”</h1>

    <?php if (!empty($blogSourcePosts)): ?>
        <h3 class="mb-3">News &amp; Articles (<?= count($blogSourcePosts) ?>)</h3>
        <div class="row g-4">
            <?php foreach ($blogSourcePosts as $blog): ?>
            <div class="col-lg-6">
    ...
    <?php if (empty($blogSourcePosts) && empty($pagesSearchResults)): ?>
