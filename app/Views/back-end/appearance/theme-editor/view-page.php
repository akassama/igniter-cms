...
<!-- page title -->
<?= $this->section('title') ?><?= lang('App.page_file_editor') ?><?= $this->endSection() ?>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <?= lang('App.editing') ?> <?='.../Views/front-end/themes/'.getCurrentTheme().'/pages/'.$viewPageFilename?>
                    </div>
                    <div>
                        <a href="<?= base_url('account/appearance/theme-editor/save-version?id=view-page') ?>" class="btn btn-outline-secondary me-2" id="saveVersionBtn">
