    ...
    <div class="col-12 bg-light rounded p-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <textarea rows="1" class="form-control" id="description" name="description" required><?= $category_data['description'] ?></textarea>
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input type="text" class="form-control alphanumeric" id="group" name="group" data-show-err="true" maxlength="100" value="<?= $category_data['group'] ?>">
                <!-- Error -->
            ...
            <!--hidden inputs -->
            <div class="col-12">
                <input type="hidden" class="form-control" id="category_id" name="category_id" value="<?= $category_data['category_id']; ?>" />
                <input type="hidden" class="form-control" id="created_by" name="created_by" value="<?= $category_data['created_by']; ?>" />
            </div>
