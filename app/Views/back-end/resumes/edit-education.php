...
<!-- page title -->
<?= $this->section('title') ?>Edit Education<?= $this->endSection() ?>
    ...
    <div class="col-12 bg-light rounded p-4">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 mb-3">
                ...
                <textarea rows="1" class="form-control" id="description" name="description" maxlength="500"><?= $education_data['description']; ?></textarea>
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <select class="form-select" aria-label="group" id="group" name="group">
                    ...
                    <?=getDataGroupOptions($education_data['group'], "Education")?>
                </select>
                <!-- Error -->
