    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item"><a href="<?=base_url('/appointments')?>" class="text-decoration-none text-primary">Appointments</a></li>
                <li class="breadcrumb-item active text-secondary" aria-current="page">Appointment Details</li>
            </ol>
        </nav>
    </div>
</section>
