...
<!-- page title -->
<?= $this->section('title') ?>Sitemap File Editor<?= $this->endSection() ?>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        Editing <?='.../Views/front-end/themes/'.getCurrentTheme().'/sitemap/'.$sitemapFilename?>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 60em; width: 100%;"><?= htmlspecialchars($sitemapFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $sitemapFilePath ?>">
                    <input type="hidden" name="filePage" value="sitemap">
