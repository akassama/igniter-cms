...
<!-- page title -->
<?= $this->section('title') ?>Events File Editor<?= $this->endSection() ?>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        Editing <?='.../Views/front-end/themes/'.getCurrentTheme().'/events/'.$eventsFilename?>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 60em; width: 100%;"><?= htmlspecialchars($eventsFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $eventsFilePath ?>">
                    <input type="hidden" name="filePage" value="view-events">
