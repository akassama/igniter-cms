...
<!-- page title -->
<?= $this->section('title') ?>New Testimonial<?= $this->endSection() ?>
...
<div class="row">
    ...
    <div class="col-12 bg-light rounded p-4">
        ...
        <?php echo form_open(base_url('account/cms/testimonials/edit-testimonial'), 'method="post" class="row g-3 needs-validation save-changes" enctype="multipart/form-data" novalidate'); ?>
        <div class="row">
            <div class="col-sm-12 col-md-6 mb-3">
                <label for="name" class="form-label">Name</label>
                <input type="text" class="form-control title-text" id="name" name="name" data-show-err="true" maxlength="100" value="<?= $testimonial_data['name'] ?>" required>
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input type="text" class="form-control title-text" id="title" name="title" data-show-err="true" maxlength="250" value="<?= $testimonial_data['title'] ?>" required>
                <!-- Error -->
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="image" name="image" maxlength="250" placeholder="select image" value="<?= $testimonial_data['image'] ?>"
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input type="text" class="form-control integer-plus-only" id="rating" name="rating" data-show-err="true" maxlength="3" value="<?= $testimonial_data['rating'] ?>" required>
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-12 mb-3">
                <div class="row">
                    <div class="col-sm-12 col-md-9">
                        ...
                        <input type="text" class="form-control" id="link" name="link" value="<?= $testimonial_data['link'] ?>">
                        <!-- Error -->
                    ...
                    <div class="col-sm-12 col-md-3">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="new_tab" name="new_tab" value="1" <?= ($testimonial_data['new_tab'] == '1') ? 'checked' : '' ?>>
            ...
            <!--hidden inputs -->
            <div class="col-12">
                <input type="hidden" class="form-control" id="testimonial_id" name="testimonial_id" value="<?= $testimonial_data['testimonial_id']; ?>" />
                <input type="hidden" class="form-control" id="created_by" name="created_by" value="<?= $testimonial_data['created_by']; ?>" />
            </div>
