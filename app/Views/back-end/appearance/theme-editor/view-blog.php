...
<!-- page title -->
<?= $this->section('title') ?><?= lang('App.blog_file_editor') ?><?= $this->endSection() ?>
...
$breadcrumb_links = array(
    ...
    array('title' => lang('App.blog_file_editor'))
);
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <?= lang('App.editing') ?> <?='.../Views/front-end/themes/'.getCurrentTheme().'/blogs/'.$viewBlogFilename?>
                    </div>
                    <div>
                        <a href="<?= base_url('account/appearance/theme-editor/save-version?id=view-blog') ?>" class="btn btn-outline-secondary me-2" id="saveVersionBtn">
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 75em; width: 100%;"><?= htmlspecialchars($viewBlogFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $viewBlogFilePath ?>">
                    <input type="hidden" name="filePage" value="view-blog">
