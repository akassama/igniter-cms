...
<!-- page title -->
<?= $this->section('title') ?>File Manager<?= $this->endSection() ?>
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <?= form_open_multipart('account/file-manager/add-file-url', ['class' => 'needs-validation', 'novalidate' => '']) ?>
            <div class="row">
                <div class="mb-3">
                    <label for="upload_file" class="form-label">File URL</label>
                    <input type="url" class="form-control" id="upload_file" name="upload_file" required>
                    <!-- Error -->
            ...
            <div class="mt-3">
                <button type="submit" class="btn btn-outline-primary">
                    <i class="ri-upload-2-line"></i> Add File
                </button>
                <a href="<?=base_url('/account/file-manager/upload-file')?>" class="btn btn-outline-dark float-end">
                    <i class="ri-folder-fill"></i> Add From Device
                </a>
            </div>
        <?= form_close() ?>
    </div>
