...
<!-- page title -->
<?= $this->section('title') ?>Site JS File Editor<?= $this->endSection() ?>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        Editing <?='.../Views/front-end/themes/'.getCurrentTheme().'/search/'.$siteJSFilename?>
                    </div>
                    <div>
