...
<div class="row">
    ...
    <div class="col-12 bg-light rounded p-4">
        ...
        <?php echo form_open(base_url('account/cms/content-blocks/edit-content-block'), 'method="post" class="row g-3 needs-validation save-changes" enctype="multipart/form-data" novalidate'); ?>
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <textarea rows="1" class="form-control" id="description" name="description" required><?= $content_block_data['description']; ?></textarea>
                <!-- Error -->
            ...
            <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input type="text" class="form-control alphanumeric" id="group" name="group" data-show-err="true" maxlength="100" value="<?= $content_block_data['group'] ?>">
                <!-- Error -->
