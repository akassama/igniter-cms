...
<!-- page title -->
<?= $this->section('title') ?><?= lang('App.home_file_editor') ?><?= $this->endSection() ?>
...
$breadcrumb_links = array(
    ...
    array('title' => lang('App.home_file_editor'))
);
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <button class="btn btn-outline-dark mx-1" data-bs-toggle="modal" data-bs-target="#previewPageModal" data-page-url="<?= base_url('home') ?>">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <?= lang('App.editing') ?> <?='.../Views/front-end/themes/'.getCurrentTheme().'/home/'.$homeFilename?>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 75em; width: 100%;"><?= htmlspecialchars($homeFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $homeFilePath ?>">
                    <input type="hidden" name="filePage" value="home">
