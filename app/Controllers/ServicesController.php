...
class ServicesController extends BaseController
{
   ...
   */
     ...
     *
     * @param {string|number} userId The ID of the user to unsubscribe.
     * @returns {void}
     */
    public function unsubscribe($userId)
    {
        ...
        $updateWhereClause = "subscriber_id = '$userId'";
        $result = updateRecordColumn("subscribers", $updateColumn, $updateWhereClause);
    ...
    /**
     * Resubscribes a user to the service.
     *
     * @param {string|number} userId The ID of the user to resubscribe.
     * @returns {void}
     */
    public function resubscribe($userId)
    {
        ...
        if ($result) {
            ...
            // Return an error response (HTTP 500 Internal Server Error)
            http_response_code(500);
            echo json_encode(['success' => false, 'message' => 'Unable to process your unsubscribe request.']); // Note: message should probably be 'Unable to process your resubscribe request.'
        }
    }
}
