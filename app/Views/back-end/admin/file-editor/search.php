        ...
        <form id="saveFileForm" method="post" action="<?= base_url('account/admin/file-editor/save-file') ?>">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 60em; width: 100%;"><?= htmlspecialchars($searchFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $searchFilePath ?>">
                    <input type="hidden" name="filePage" value="search">
