...
<!-- page title -->
<?= $this->section('title') ?>Contacts File Editor<?= $this->endSection() ?>
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        Editing <?='.../Views/front-end/themes/'.getCurrentTheme().'/contact/'.$contactFilename?>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 60em; width: 100%;"><?= htmlspecialchars($contactFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $contactFilePath ?>">
                    <input type="hidden" name="filePage" value="contact">
