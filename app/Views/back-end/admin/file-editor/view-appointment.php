...
<!-- page title -->
<?= $this->section('title') ?>Appointment File Editor<?= $this->endSection() ?>
...
$breadcrumb_links = array(
    ...
    array('title' => 'Edit View Appointment File')
);
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        Editing <?='.../Views/front-end/themes/'.getCurrentTheme().'/appointments/'.$viewAppointmentFilename?>
                    </div>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div id="editor" style="height: 60em; width: 100%;"><?= htmlspecialchars($viewAppointmentFileContent) ?></div>
                    <input type="hidden" name="filePath" value="<?= $viewAppointmentFilePath ?>">
                    <input type="hidden" name="filePage" value="view-appointment">
