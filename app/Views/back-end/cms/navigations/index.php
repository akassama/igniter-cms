                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row text-center p-1">
                                            ...
                                            <div class="col mb-1">
                                                <a class="text-dark td-none mr-1 remove-navigation" href="javascript:void(0)" onclick="deleteRecord('navigations', 'navigation_id', '<?=$navigation['navigation_id'];?>', '', 'account/cms/navigations')">
