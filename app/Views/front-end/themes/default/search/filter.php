                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4 text-center">
                            ...
                            <form action="<?= base_url('search') ?>" method="get">
                                <div class="mb-3">
                                    <input type="text" name="q" class="form-control form-control-lg" placeholder="Try a different keyword" value="<?= esc($searchQuery) ?>">
                                </div>
                ...
                <div class="col-lg-8 mx-auto">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4 text-center">
                            ...
                            <h3 class="fw-bold mb-3">Didn't find what you needed?</h3>
                            <p class="text-muted mb-4">Let us know so we can help or improve our content.</p>
                            <form action="<?= base_url('search') ?>" method="get">
                                <div class="mb-3">
                                    <input type="text" name="q" class="form-control form-control-lg" placeholder="Search again..." value="<?= esc($searchQuery) ?>">
                                </div>
